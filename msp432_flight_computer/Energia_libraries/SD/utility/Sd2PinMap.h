 ...
 */
#if defined(__arm__) // Arduino Due Board follows + MSP432

#ifndef Sd2PinMap_h
#define Sd2PinMap_h

#include <Arduino.h>
uint8_t const SS_PIN = 13; //32 - P5.0
uint8_t const MOSI_PIN = 15; //8 - P1.6
uint8_t const MISO_PIN = 14; //13 - P1.7
uint8_t const SCK_PIN = 7; //11 - P1.5
/*
